...
import com.mualab.org.user.Views.zoomage.ZoomageView;
import com.mualab.org.user.activity.artist_profile.adapter.CertificatesListAdapter;
import com.mualab.org.user.activity.artist_profile.listener.OnCertificateClickListener;
...
public class CertificateActivity extends AppCompatActivity implements OnCertificateClickListener {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("success")) {
                        ...
                        for(int i=0; i<jsonArray.length(); i++){
                            ...
                            item.title = cObj.getString("title");
                            item.description = cObj.getString("description");
                            item.crd = cObj.getString("crd");
                            item.upd = cObj.getString("upd");
    ...
    public void onCertificateClick(int position) {
        ...
        Intent intent = new Intent(CertificateActivity.this,CertificateDescriptionActivity.class);
