...
public class SomeOneAdapter extends RecyclerView.Adapter<SomeOneAdapter.ViewHolder> {
  ...
  /*  private RequestOptions requestOptions =
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide
                .with(mContext)
                .load(someOne.getUrl()).centerCrop().placeholder(R.drawable.default_placeholder)
                .diskCacheStrategy(DiskCacheStrategy.NONE).placeholder(R.drawable.default_placeholder)
