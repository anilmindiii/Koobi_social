...
public class HttpTask {
    ...
    public static class Builder {
        ...
        public Builder(Context context, String api, HttpResponceListner.Listener listener) {
            if (api.startsWith("https://api.postcodes.io")) {
                postalCodeApi = api;
            } else this.api = api;
    ...
    public HttpTask(Builder builder) {
        ...
        if (builder.postalCodeApi.startsWith("https://api.postcodes.io")) {
            this.api = builder.postalCodeApi;
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (context != null) {
                    if (progress)
                        Progress.hide(context);
                    if(api.startsWith(("https://api.postcodes.io"))){
                        MyToast.getInstance(context).showDasuAlert(" Please enter valid postcode");
